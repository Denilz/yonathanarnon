        ...
        <div className="lesson-content">
          <div className="video-container">
            ...
            <iframe
              width="560"
              height="315"
              src="https://storage.googleapis.com/yonathanarnon/coursevideos/hookdef.mp4"
              title="Lesson Video"
              frameBorder="0"
          ...
          <p className="text-content"><b> {/* Added className */}
            ...
            הפרק הזה הוא הראשון מסדרת פרקים המסבירים טכניקת בסיס של איגרוף קלאסי, בפרק הזה  בעיקר בנושאים הבאים
